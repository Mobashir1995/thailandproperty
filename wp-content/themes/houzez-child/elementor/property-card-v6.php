 ...
 * @since 2.0
 */
class Plugin_Devs_Elementor_Property_Card_V6 extends Widget_Base {
	...
	public function get_name() {
		return 'pd_houzez_elementor_property-card-v6';
	}
	...
	public function get_title() {
		return esc_html__( 'Custom Property Cards v6', 'houzez-theme-functionality' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'exclude' => array( 'custom', 'thumbnail', 'houzez-image_masonry', 'houzez-map-info', 'houzez-variable-gallery', 'houzez-gallery' ),
				'include' => array(),
	...
	protected function render() {
		...
		// $property_area = get_field('acf_area_field');
		if ( ! empty( $settings['property_area'] ) ) {
			$property_area = $settings['property_area'];
		}
...
Plugin::instance()->widgets_manager->register_widget_type( new Plugin_Devs_Elementor_Property_Card_V6() );
