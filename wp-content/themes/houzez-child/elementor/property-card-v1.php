 ...
 * @since 2.0
 */
class Plugin_Devs_Elementor_Property_Card_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'pd_houzez_elementor_property-card-v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Custom Property Cards v1', 'houzez-theme-functionality' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Plugin_Devs_Elementor_Property_Card_V1() );
