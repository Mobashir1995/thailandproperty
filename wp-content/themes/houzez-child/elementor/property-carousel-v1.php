 ...
 * @since 1.5.6
 */
class PluginDevs_Houzez_Elementor_Properties_Carousels_v2 extends Widget_Base {
    ...
    public function get_name() {
        return 'pd_houzez_elementor_properties_carousel_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Custom Property Cards Carousel v1', 'houzez-theme-functionality' );
    }
    ...
    protected function render() {
        ...
        $dots = '<div class="pd-slick-dot-container">
            <div class="pd-slick-dot-prev">
                <i class="fas fa-angle-left"></i>
            </div>
            <div class="pd-slick-dot-lists"></div>
            <div class="pd-slick-dot-next">
...
Plugin::instance()->widgets_manager->register( new PluginDevs_Houzez_Elementor_Properties_Carousels_v2 );